...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: `${SITE_URL}/adira-finance-ciputat`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${SITE_URL}/adira-finance-pasar-baru`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${SITE_URL}/adira-finance-tajur`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${SITE_URL}/adira-finance-tebet`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${SITE_URL}/adira-finance-pondok-gede`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    ...
    {
      url: `${SITE_URL}/adira-finance-kelapa-gading`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.7,
    },
